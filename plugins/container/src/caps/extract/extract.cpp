...
std::vector<falcosecurity::field_info> my_plugin::get_fields()
{
    ...
    const falcosecurity::field_info fields[] = {
            ...
            {ft::FTYPE_STRING, "k8s.rc.label",
             ...
             "Deprecated. Use `k8smeta` plugin instead.", req_key_arg},
...
bool my_plugin::extract(const falcosecurity::extract_fields_input &in)
{
    ...
    bool is_container_async_event_create = false;
    bool is_container_async_event_remove = false;
       ...
       is_container_async_event_create || is_container_async_event_remove)
    {
        ...
        // We just generated a container-related event
        // and we are asked to extract from it; use the stored container
        // metadata.
